...
/* monado-rift-wayland addition: expose the number of attached camera
 * sensors so the Monado driver can report 3DoF vs 6DoF tracking state. */
int
rift_tracker_get_sensor_count(rift_tracker_ctx *ctx)
{
	if (ctx == NULL) {
		return 0;
	}
